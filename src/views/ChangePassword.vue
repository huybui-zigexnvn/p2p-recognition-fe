                        ...
                        <div class="input-group ">
                          <span class="input-group-text">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" viewBox="0 0 512 512"
                              role="img">undefined<path fill="var(--ci-primary-color, currentColor)"
                          ...
                          <input v-model="password" :placeholder="$t('change_password.password.placeholder')"
                            class="form-control" type="password" name="password" required />
                        </div>
                        <InvalidFieldErrorMessage errorField="password" :errorMessages="errorMessages">
                      ...
                      <div class="mb-4">
                        <div class="input-group ">
                          ...
                          <input v-model="passwordConfirmation"
                            :placeholder="$t('change_password.password_confirmation.placeholder')" class="form-control"
                            type="password" name="password_confirmation" required />
                        </div>
                        <InvalidFieldErrorMessage errorField="password_confirmation" :errorMessages="errorMessages">
                        </InvalidFieldErrorMessage>
                      </div>
                      <div class="row">
...
export default {
  ...
  components: { InvalidFieldErrorMessage, PageNotFound, Loader },
  mixins: [loaderMixin],
  data() {
    return {
      password: '',
